...
#Reccoger también los cookies de la página de busqueda
cookie = r1.cookies
...
#Rellenar el payload
# Aquí no tengo muy claro si son necesarios todos los datos
payload["draw"] = "1"
...
payload["start"] = "0"
# Esto se puede cambiar por 17566 y tendríamos todos los modelos
payload["length"] = ""
...
# Aqui también cambiaría el valor lenght de 10 por 17566
...
#Imprimir el resultado de la llmada
print("codigo estado",r2.status_code)

# Cargar la salida en una variable d formato json
json_salida = json.loads(r2.text)

# Recoger el elemento draw de la salida
json_draw = json_salida["draw"]
print(json_draw)

#recoger el número de elementos totales
json_recordsTotal = json_salida["recordsTotal"]
print(json_recordsTotal)

#Recoger el número de elementos filtrados
json_recordsFiltered = json_salida["recordsFiltered"]
print(json_recordsFiltered)

# REcoger el contenido del elemento data
json_data = json_salida["data"]
print(json_data)

# Aquí hay que  procear el elemento data.
# A modo de ejemplo se coge del primer coche la primera característica que es el modelo
modelo = json_salida["data"][0][0]
print("modelo: " , modelo)
