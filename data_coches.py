...
#Revisar fichero robots.txs
rp = robotparser.RobotFileParser()
url_robots = 'http://coches.idae.es/robots.txt'
...
resultado = rp.can_fetch(agent, url_robots)

# En caso de que no esté permitido el acceso salir del programa
if (resultado == True):
    print("Acceso permitido")
else:    
    print("No es posible realizar operaciones scraping sobre esta página")						
    exit(0)
